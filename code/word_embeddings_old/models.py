...
def build_word2vec_model(vocab_size: int, vector_dim: int):
    ...
    # Embedding layer using Dense layers
    target_embedding = Dense(vector_dim, input_shape=input_shape, name='target_embedding')(input_target)
    context_embedding = Dense(vector_dim, input_shape=input_shape, name='context_embedding')(input_context)
