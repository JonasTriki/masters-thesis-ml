"""
Dunn index implementation. Source:
https://gist.github.com/douglasrizzo/cd7e792ff3a2dcaf27f6 (downloaded 10th of January 2021).

Contains minor changes/improvements to fit our needs.
"""
...
def diameter(labels, distances, method="farthest"):
    ...
    if method == "mean_cluster":
        ...
        for i in range(len(diameters)):
            ...
            # Minor fix to denominator
            # Source: https://gist.github.com/douglasrizzo/cd7e792ff3a2dcaf27f6#gistcomment-3433850
            N = sum(labels == i)
            diameters[i] /= N * (N - 1) / 2
