#!/bin/bash
screen -dmS word2vec_dawiki -L -Logfile word2vec_dawiki.logs python train_word2vec.py \
--text_data_dir data/dawiki-20210101_phrases/epoch_2 \
--dataset_name dawiki \
--output_dir ../output/word2vec_training \
--save_to_tokenizer_filepath data/dawiki-20210101.tokenizer \
