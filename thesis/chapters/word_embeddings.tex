...
\begin{itemize}
    \item \textbf{\textit{batch\_size}} \\
        Batch size is the number of positive target-context pairs $(w_t, w_{t+j})$ we train on in each training step, e.g., the number of forward passes we perform in our ANN before we do a backwards pass.
    \item \textbf{\textit{num\_epochs}} \\
    ...
    \item \textbf{\textit{learning\_rate}} \\
    ...
    \item \textbf{\textit{min\_learning\_rate}} \\
    ...
    \item \textbf{\textit{max\_vocab\_size}} \\
    ...
    \item \textbf{\textit{embedding\_dim}} \\
        The embedding dimension denotes the dimension we want to use for the internal matrices $W$ and $W'$ in our ANN, e.g., the dimensionality of the word vectors.
    \item \textbf{\textit{min\_word\_count}} \\
    ...
    \item \textbf{\textit{max\_window\_size}} \\
    ...
    \item \textbf{\textit{num\_negative\_samples}} \\
    ...
    \item \textbf{\textit{sampling\_factor}} \\
    ...
    \item \textbf{\textit{unigram\_exponent}} \\
...
\subsection{Implementation specifics and hyperparameter choices}
To implement the word2vec model, we used Python and Tensorflow \cite{python3-2009, tensorflow2015-whitepaper}. \textbf{TODO: What to write here? Hyperparameter choices only?}
